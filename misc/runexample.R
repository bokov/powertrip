...
library(Survomatic)
logenv <- load.ptenv('pt_result.rdata')
...
.out <- powertrip(logenv,refcoords=lrefcoords,maxs=lrelmaxs,mins=lrelmins,npoints=100,pnlst=pnlst_gmcx,ptsim=ptsim_surv,nrads=60,backtrans=exp,type='gm',tol=0.1)
