...
#lfzmaxs <- c(4,-0.005,6);
#lfzmins <- c(-2,-0.75,1);
nnrefs <- c(setNames(lrefcoords,c('imr','roa','eh')),nn=log(20));
...
nnmaxs <- c(lrelmaxs,log(120/20)); #c(6.609438,1.630519,10,6.39692965521615);
...
.out <- powertrip(logenv #,refcoords=lrefcoords
                  ...
                  ,instance=as.character(Sys.time(),'i%y%m%d%I%M.20.120.nn')
