...
# in next run, try expanding to... c(0.000448943309591518, 0.0195827842383701, 0.058737528647514)
lrelmaxs<-((lmaxs<-log(maxs <- c(1e-04, 0.0195827842383701, 0.001145822)))-lrefcoords);
# in next run try expanding to ... c(1.01475976473711e-09, 0.00103798220880217, 1e-16)
